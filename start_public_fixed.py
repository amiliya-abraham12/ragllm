...
No sign-up or installation needed â€” uses SSH tunneling.
...
def main():
    ...
    print("=" * 58)
    print("  ðŸŒ LlamaRAG Assist â€” Public Access Tunnel")
    print("=" * 58)
    print(f"\nðŸ“¡ Creating public tunnel to localhost:{port}...")
    ...
    try:
        ...
        if stdout is None:
            print("âŒ Failed to capture output")
            return
        for line in iter(stdout.readline, ""):
            ...
            if url_match and not url_found:
                ...
                url_found = True
                print("=" * 58)
                print("  âœ… YOUR PUBLIC API URL:")
                print(f"\n  ðŸ”— {public_url}")
                print(f"\n  ðŸ“– Docs:    {public_url}/docs")
                print(f"  ðŸ’š Health:  {public_url}/api/health")
                print(f"  ðŸ¤– Ask:     POST {public_url}/api/ask")
                print(f"\n  ðŸ“‹ Share this URL â€” anyone can access your API!")
                print("=" * 58)
        ...
        print("âŒ SSH not found! Install OpenSSH:")
